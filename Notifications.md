...
found [here](https://github.com/jusahyv/freshchat-phonegap).

It can be installed by the following command : 
```shell
cordova plugin add https://github.com/jusahyv/freshchat-phonegap.git
```
If you are setting it up for Android as well, add the Sender Id as well, so the command would look like:
```shell
cordova plugin add https://github.com/jusahyv/freshchat-phonegap.git --variable SENDER_ID=20738924380
```
Plugin can also be added from config.xml as follows:
```javascript
<plugin name="phonegap-plugin-push" spec="https://github.com/jusahyv/freshchat-phonegap.git">
